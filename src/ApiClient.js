...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.govinfoLinkService.ApiClient = factory(root.superagent, root.querystring)
  }
  ...
  const exports = function () {
     ...
     * @type {String}
     * @default https://www.govinfo.gov/link
     */

    this.basePath = 'https://www.govinfo.gov/link'.replace(/\/+$/, '')
    ...
    for (const key in collectionQueryParams) {
      if (collectionQueryParams.hasOwnProperty(key)) {
        ...
        if (param.collectionFormat === 'csv') {
          ...
          if (param.value != null) {
            const value = param.value.map(this.paramToString).map((x) => encodeURIComponent(x))
              .join(',')
