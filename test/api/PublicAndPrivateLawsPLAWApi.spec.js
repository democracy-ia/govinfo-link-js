...
(function(root, factory) {
  ...
  describe('PublicAndPrivateLaws', function() {
    describe('plawBillFetchUsingGET', function() {
      it('should call plawBillFetchUsingGET successfully', function(done) {
    ...
    describe('plawStatuteFetchUsingGET', function() {
      it('should call plawStatuteFetchUsingGET successfully', function(done) {
    ...
    describe('plawTypeFetchUsingGET', function() {
      it('should call plawTypeFetchUsingGET successfully', function(done) {
