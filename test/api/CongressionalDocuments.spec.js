...
(function (root, factory) {
  ...
  describe('CongressionalDocuments', () => {
    describe('cdocFetchUsingGET', () => {
      it('should call cdocFetchUsingGET successfully', (done) => {
        /*
    ...
    describe('cdocJacketFetchUsingGET', () => {
      it('should call cdocJacketFetchUsingGET successfully', (done) => {
        /*
