...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new govinfoLinkService.FederalRegister();
  });
  ...
  describe('FederalRegister', function() {
    describe('frDocFetchUsingGET', function() {
      it('should call frDocFetchUsingGET successfully', function(done) {
        //uncomment below and update the code to test frDocFetchUsingGET
        //instance.frDocFetchUsingGET(function(error) {
    ...
    describe('frVolumeFetchUsingGET', function() {
      it('should call frVolumeFetchUsingGET successfully', function(done) {
        //uncomment below and update the code to test frVolumeFetchUsingGET
        //instance.frVolumeFetchUsingGET(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
