...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new govinfoLinkService.StatutesAtLarge();
  });
  ...
  describe('StatutesAtLarge', function() {
    describe('statuteTypeFetchUsingGET', function() {
      it('should call statuteTypeFetchUsingGET successfully', function(done) {
        //uncomment below and update the code to test statuteTypeFetchUsingGET
        //instance.statuteTypeFetchUsingGET(function(error) {
    ...
    describe('statuteVolumeFetchUsingGET', function() {
      it('should call statuteVolumeFetchUsingGET successfully', function(done) {
        //uncomment below and update the code to test statuteVolumeFetchUsingGET
        //instance.statuteVolumeFetchUsingGET(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
