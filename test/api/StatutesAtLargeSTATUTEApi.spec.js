...
(function (root, factory) {
  ...
  describe('StatutesAtLarge', () => {
    describe('statuteTypeFetchUsingGET', () => {
      it('should call statuteTypeFetchUsingGET successfully', (done) => {
        /*
    ...
    describe('statuteVolumeFetchUsingGET', () => {
      it('should call statuteVolumeFetchUsingGET successfully', (done) => {
        /*
