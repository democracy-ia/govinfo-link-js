...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new govinfoLinkService.CompilationOfPresidentialDocuments();
  });
  ...
  describe('CompilationOfPresidentialDocuments', function() {
    describe('cpdDcpdFetchUsingGET', function() {
      it('should call cpdDcpdFetchUsingGET successfully', function(done) {
        //uncomment below and update the code to test cpdDcpdFetchUsingGET
        //instance.cpdDcpdFetchUsingGET(function(error) {
    ...
    describe('cpdFetchUsingGET', function() {
      it('should call cpdFetchUsingGET successfully', function(done) {
        //uncomment below and update the code to test cpdFetchUsingGET
        //instance.cpdFetchUsingGET(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
