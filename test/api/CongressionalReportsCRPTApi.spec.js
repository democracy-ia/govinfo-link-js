...
(function(root, factory) {
  ...
  describe('CongressionalReports', function() {
    describe('crptBillFetchUsingGET', function() {
      it('should call crptBillFetchUsingGET successfully', function(done) {
    ...
    describe('crptReportFetchUsingGET', function() {
      it('should call crptReportFetchUsingGET successfully', function(done) {
