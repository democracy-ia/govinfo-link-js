...
(function(root, factory) {
  ...
  describe('CongressionalCommitteePrints', function() {
    describe('cprtHouseFetchUsingGET', function() {
      it('should call cprtHouseFetchUsingGET successfully', function(done) {
    ...
    describe('cprtJacketFetchUsingGET', function() {
      it('should call cprtJacketFetchUsingGET successfully', function(done) {
    ...
    describe('cprtSenateFetchUsingGET', function() {
      it('should call cprtSenateFetchUsingGET successfully', function(done) {
