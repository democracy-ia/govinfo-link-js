...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new govinfoLinkService.CongressionalDocuments();
  });
  ...
  describe('CongressionalDocuments', function() {
    describe('cdocFetchUsingGET', function() {
      it('should call cdocFetchUsingGET successfully', function(done) {
        //uncomment below and update the code to test cdocFetchUsingGET
        //instance.cdocFetchUsingGET(function(error) {
    ...
    describe('cdocJacketFetchUsingGET', function() {
      it('should call cdocJacketFetchUsingGET successfully', function(done) {
        //uncomment below and update the code to test cdocJacketFetchUsingGET
        //instance.cdocJacketFetchUsingGET(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
